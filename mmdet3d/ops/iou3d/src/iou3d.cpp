...
int paired_boxes_overlap_bev_gpu(at::Tensor boxes_a, at::Tensor boxes_b, at::Tensor ans_overlap) {
  ...
  pairedboxesoverlapLauncher(num, boxes_a_data, boxes_b_data, ans_overlap_data);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("paired_boxes_overlap_bev_gpu", &paired_boxes_overlap_bev_gpu,
        "paired oriented boxes overlap");
