...
train_pipeline = [
    ...
    dict(
        ...
        sample_method="depth",
        modify_points=False,
    ),  # comment this for the last 5 epoch
    dict(
...
load_from = "data/ckpts/merged_uvtr_fusion_vs0.075_finetune_test.pth"  # the weights are got by merging the weights of uvtr_lidar and uvtr_cam
resume_from = None
